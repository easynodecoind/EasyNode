...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("EasyNode Core easynode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  easynode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded easynode transaction") + "\n" +
              "  easynode-tx [options] -create [commands]   " + _("Create hex-encoded easynode transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded easynode transaction

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("EasyNode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About EasyNode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  easynode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the EasyNode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EASY, 0.1 EASY, 1 EASY and 10 EASY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://easynodecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://easynodecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("EasyNode Core is shutting down...") + "<br /><br />" +

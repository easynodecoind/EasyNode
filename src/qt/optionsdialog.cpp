    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EASY-light"), QVariant("light"));
    ui->theme->addItem(QString("EASY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EASY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EASY-traditional"), QVariant("trad"));

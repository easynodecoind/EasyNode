    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("EasyNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EasyNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and easynode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About EasyNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about EasyNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EasyNode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EasyNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EasyNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a easynode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EasyNode Core help message to get a list with possible EasyNode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("EasyNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EasyNode network", "", count));
}
...
{
    QString strTitle = tr("EasyNode Core"); // default title

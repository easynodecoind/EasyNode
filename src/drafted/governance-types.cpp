...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EasyNodeNetwork") type = EasyNodeNetwork;
    if(strType == "EasyNodeNetworkVariable") type = EasyNodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EasyNodeNetwork) s = "EasyNodeNetwork";
    if(type == EasyNodeNetworkVariable) s = "EasyNodeNetworkVariable";

...
{
    if(fLiteMode) return; // ignore all EasyNode related functionality
...
/*
    ...
    allow endless transaction that would bloat EasyNode and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("easynode-privatesend");

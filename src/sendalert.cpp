...
2. run easynoded with -printalert or -sendalert like this:
   /path/to/easynoded -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.easynode.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/EasyNode Core:0.12.0.58/"));

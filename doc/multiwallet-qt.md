...
Only requiring some minor changes is easynode.cpp.
...
Changes to easynode.cpp
----------------------
easynode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

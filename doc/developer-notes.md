...
EasyNode Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12450.
...
However, in open source software such as EasyNode Core, where everyone uses
...
pay attention to for reviewers of EasyNode Core code.

General EasyNode Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: EasyNode Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
This mechanism has been integrated into Bitcore-Node-EasyNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/easynodecoin/insight-api-easynode#web-socket-api](https://github.com/easynodecoin/insight-api-easynode#web-socket-api) 
* API: [https://github.com/easynodecoin/insight-api-easynode#instantsend-transactions](https://github.com/easynodecoin/insight-api-easynode#instantsend-transactions) 
...
By default, the EasyNode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EasyNode Core daemon:
